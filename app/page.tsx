        ...
        >
          <div>
            <p className="eyebrow" style={{ marginBottom: 18 }}>
              <B
                zh="湾区 AI 社区 · 黑客松 · WORKSHOP"
                en="Bay Area AI community · hackathons · workshops"
              />
            </p>
            ...
            <p style={{ margin: '20px 0 0', fontSize: 17, lineHeight: 1.65, color: 'var(--ink-3)', maxWidth: '47ch' }}>
              <B
                zh="我们把湾区的 Builder 放进同一个房间——自 2025 年 1 月以来 25 场活动、6,300+ 报名。你带品牌来，房间我们来。"
                en="We put the Bay Area's builders in one room — 25 events and 6,300+ registrations since January 2025. Bring your brand; we bring the room."
              />
            </p>
      ...
      <section style={{ padding: '26px 28px 64px' }}>
        ...
        >
          ...
          <p className="lead" style={{ margin: '16px auto 0', maxWidth: '52ch' }}>
            <B
              zh="8 月底的单日黑客松。告诉我们你想办什么——我们带方案、场地和当天流程来。"
              en="A one-day hackathon in late August. Tell us what you want to host — we'll come back with the plan, the room and the day's funnel."
            />
          </p>
